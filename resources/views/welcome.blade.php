        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="tel:+22997481238" class="btn-outline">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-gray-400 text-sm">ekpe semé kPODJI KP 11 pont péage côté rail Von AK market</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-gold-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        <div class="flex flex-col gap-1">
                            <a href="tel:+22997481238" class="text-gray-400 hover:text-gold-400 transition-colors text-sm">+229 97 48 12 38</a>
                            <a href="tel:+22994941201" class="text-gray-400 hover:text-gold-400 transition-colors text-sm">+229 94 94 12 01</a>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        ...
                        <a href="mailto:gracedivineautomobile1@gmail.com" class="text-gray-400 hover:text-gold-400 transition-colors text-sm">gracedivineautomobile1@gmail.com</a>
                    </li>
                </ul>
            </div>
        </div>
